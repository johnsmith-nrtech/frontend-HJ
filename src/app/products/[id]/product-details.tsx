...
export default function ProductDetails({ productId }: ProductDetailsProps) {
  ...
  console.log('Error:', currentVariant);
  if (error || !product) {
    return (
    ...
    <div className="w-full overflow-hidden">
      ...
      <div className="mt-10 px-4 py-8 md:px-[32px] lg:mt-0">
        ...
        <div ref={featuresRef}>
          ...
          {featuresInView && <div className="h-[64px] md:h-[80px]" />}
          <div
            className={cn(
              ...
              { "mt-[20px] mb-8 w-full md:mt-12 md:mb-8": !featuresInView }
            )}
          >
                    ...
                    {tabList.map((tab) => (
                      <CarouselItem key={tab.key} className="basis-[auto]">
                        <button
                          ...
                          className={`min-w-fit flex-shrink-0 rounded-full border px-2 py-2 text-xs font-medium whitespace-nowrap transition-all ${
                            selectedTab === tab.key
