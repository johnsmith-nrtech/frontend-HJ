...
//               data: updateData,
//             });
//             if (newVariant.material_info) {
//               updateData.material_info = newVariant.material_info;
//               hasUpdates = true;  
//           } 
//           }
//         }
...
//         armrest_height: { cm: 0, inches: 0 },
//       },
//       material_info: variant.material_info || {
//         scatter_cushion_cover: "",
//         scatter_cushion_filling: "",
//         frame_info: "",
//         seat_base_info: "",
    ...
    try {
      if (editingIndex !== null) {
        ...
        if (newImages.length > 0) {
          ...
          console.log(`Uploading ${files.length} new images as type: ${imageType}`);
          await uploadImagesMutation.mutateAsync({
            variantId: existingVariant.id,
            files,
            type: imageType,
  ...
  await updateVariantMutation.mutateAsync({
    ...
    data: updateData,
        ...
        if (newImages.length > 0) {
          ...
          console.log(`Uploading ${files.length} images for new variant as type: ${imageType}`);
          await uploadImagesMutation.mutateAsync({
            variantId: createdVariant.id,
            files,
            type: imageType,
        ...
        <CardContent className="space-y-4">
          <Tabs defaultValue="details" className="w-full">
            ...
            <TabsContent value="details" className="space-y-4">
              ...
              {/* Material Composition & Construction Section */}
              <div className="space-y-3 border-t pt-4">
                <h4 className="text-sm font-medium">Material Composition & Construction</h4>
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  <div className="col-span-2">
