...
export function ProductCard({
  ...
  <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
    ...
    <span className={`line-clamp-1 inline-flex items-center gap-1 rounded-xl bg-[#3293a8] px-2 py-1 text-xs font-medium text-white w-fit mt-1 ${showInstallments ? "" : "invisible"}`}>
  ...
  {showInstallments ? (
    ...
    <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "flex-end", alignItems: "flex-end" }}>
      <span className="line-clamp-1 inline-block rounded-xl bg-[#3293a8] px-2 py-1 text-xs font-medium text-white w-fit">
        {deliveryInfo}
      </span>
    </div>
  )}
  ...
  <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
    ...
    <span className={`line-clamp-1 inline-flex items-center gap-1 rounded-xl bg-[#56748e] px-2 py-1 text-xs font-medium text-white w-fit mt-1 ${showInstallments ? "" : "invisible"}`}>
      <Truck className="h-3 w-3 shrink-0" />
      {deliveryInfo}
    </span>
  </div>

  {/* Right side: divider + installments OR delivery badge, always 3 lines tall */}
  {showInstallments ? (
    <>
    ...
    <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "flex-end", alignItems: "flex-end" }}>
      <span className="line-clamp-1 inline-block rounded-xl bg-[#56748e] px-2 py-1 text-xs font-medium text-white w-fit">
        {deliveryInfo}
      </span>
    </div>
  )}
